...
(function(factory) {
  ...
  var Markdown = function(element, options) {
    ...
    var opts = ['autofocus', 'savable', 'hideable', 'width',
      ...
      'footer', 'fullscreen', 'hiddenButtons', 'disabledButtons', 'buttonSize'
    ];
      ...
      for (i = 0; i < buttonsArray.length; i++) {
        ...
        for (y = 0; y < btnGroups.length; y++) {
          ...
          for (z = 0; z < buttons.length; z++) {
            ...
            buttonContainer.text(' ' + this.__localize(btnText)).addClass('btn-default btn-' + this.$options.buttonSize).addClass(btnClass);
